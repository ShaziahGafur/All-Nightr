...
struct MapFixture {
    ...
    TEST(find_path_with_walk_to_pick_up_optimality) {
        ...
        CHECK(compute_path_travel_time(path.second, 17.24833628218366144) <= 9.41661454187774716);
        ...
        CHECK(compute_path_travel_time(path.second, 17.90710847337793510) <= 1099.25779359872285568);
        ...
        CHECK(compute_path_travel_time(path.second, 18.12706786144983084) <= 370.77573399475210181);
        ...
        CHECK(compute_path_travel_time(path.second, 16.89378956086656913) <= 341.47168612789511144);
        ...
        CHECK(compute_path_travel_time(path.second, 22.99138211696489620) <= 902.84276330149407386);
        ...
        CHECK(compute_path_travel_time(path.second, 23.92478294037437792) <= 663.81130096884749037);
        ...
        CHECK(compute_path_travel_time(path.second, 23.58207964209191232) <= 512.01164781645366020);
        ...
        CHECK(compute_path_travel_time(path.second, 21.23583356131032573) <= 68.13309640843816339);
        ...
        CHECK(compute_path_travel_time(path.second, 16.77524564084403735) <= 5.72150133366590197);
        ...
        CHECK(compute_path_travel_time(path.second, 15.32586511173930077) <= 283.36860297842258660);
        ...
        CHECK(compute_path_travel_time(path.second, 22.52695215707312926) <= 594.17848319648987854);
        ...
        CHECK(compute_path_travel_time(path.second, 16.21467047900597436) <= 47.30620227567807490);
        ...
        CHECK(compute_path_travel_time(path.second, 20.21819737661307315) <= 950.69396807004352468);
        ...
        CHECK(compute_path_travel_time(path.second, 22.95045568973362649) <= 737.40617504104625368);
        ...
        CHECK(compute_path_travel_time(path.second, 22.86015171952646341) <= 394.23731469912081593);
        ...
        CHECK(compute_path_travel_time(path.second, 24.70388500754370043) <= 240.27935825802538261);
        ...
        CHECK(compute_path_travel_time(path.second, 21.66117254177195406) <= 19.80500148597683108);
        ...
        CHECK(compute_path_travel_time(path.second, 23.46132436906174945) <= 23.59477412001551144);
        ...
        CHECK(compute_path_travel_time(path.second, 24.96924697045825781) <= 495.35556061423091023);
        ...
        CHECK(compute_path_travel_time(path.second, 21.15430917549949541) <= 762.56825503867332827);
        ...
        CHECK(compute_path_travel_time(path.second, 23.29108811416090674) <= 25.46991556612609386);
        ...
        CHECK(compute_path_travel_time(path.second, 20.80948077349938785) <= 350.97946847252626412);
        ...
        CHECK(compute_path_travel_time(path.second, 22.29047040070515351) <= 322.16022932825836733);
        ...
        CHECK(compute_path_travel_time(path.second, 16.36752755822002214) <= 529.93271520874429825);
