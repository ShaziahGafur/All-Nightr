...
struct MapFixture {
    ...
    TEST(find_path_with_walk_to_pick_up_optimality) {
        ...
        CHECK(compute_path_travel_time(path.second, 17.09186127700705882) <= 915.05869876656652195);
        ...
        CHECK(compute_path_travel_time(path.second, 18.13752153377841125) <= 54.06591089114199633);
        ...
        CHECK(compute_path_travel_time(path.second, 17.14055432418023628) <= 32.22913738132036343);
        ...
        CHECK(compute_path_travel_time(path.second, 22.51417288799332539) <= 1061.54683735284288559);
        ...
        CHECK(compute_path_travel_time(path.second, 23.55376778903119117) <= 1475.70257382363911347);
        ...
        CHECK(compute_path_travel_time(path.second, 15.92647539527768785) <= 1248.28165748978312877);
        ...
        CHECK(compute_path_travel_time(path.second, 21.81291364015829970) <= 976.02903410495935077);
        ...
        CHECK(compute_path_travel_time(path.second, 20.11897394771401792) <= 1627.31082193952443049);
        ...
        CHECK(compute_path_travel_time(path.second, 17.29162505536838879) <= 2135.38052374260587385);
        ...
        CHECK(compute_path_travel_time(path.second, 24.70825215594946300) <= 2518.44316365455870255);
        ...
        CHECK(compute_path_travel_time(path.second, 22.16138655906405575) <= 665.65191198937270656);
        ...
        CHECK(compute_path_travel_time(path.second, 23.46132436906174945) <= 33.15456143221248908);
        ...
        CHECK(compute_path_travel_time(path.second, 17.76186240368787850) <= 719.08180404185895895);
        ...
        CHECK(compute_path_travel_time(path.second, 23.26211029393396501) <= 181.56650313167651234);
        ...
        CHECK(compute_path_travel_time(path.second, 21.36468488332522853) <= 2020.44984923324341253);
        ...
        CHECK(compute_path_travel_time(path.second, 19.37938493793083694) <= 2.57041714028782664);
        ...
        CHECK(compute_path_travel_time(path.second, 16.99415734476158235) <= 2342.30090570690299501);
        ...
        CHECK(compute_path_travel_time(path.second, 17.84137078958718092) <= 2093.83908451439310738);
        ...
        CHECK(compute_path_travel_time(path.second, 16.95061114321478257) <= 992.05181926829493477);
        ...
        CHECK(compute_path_travel_time(path.second, 15.06191257662446858) <= 797.97972927826526757);
        ...
        CHECK(compute_path_travel_time(path.second, 17.56525768651765773) <= 20.00155966006685304);
        ...
        CHECK(compute_path_travel_time(path.second, 21.73181346174965611) <= 2104.83310976453685726);
        ...
        CHECK(compute_path_travel_time(path.second, 16.53896805106891676) <= 1422.98970926063293518);
        ...
        CHECK(compute_path_travel_time(path.second, 22.92007129296922940) <= 2.02719569554416745);
